...
class Scoreboard:
    ...
    def prep_score(self):
        ...
        #在右上角显示得分
        self.scpre_rect = self.score_image.get_rect()
        self.scpre_rect.right = self.screen_rect.right - 20
        self.scpre_rect.top = 20
    ...
    def show_score(self):
        """在屏幕上显示得分"""
        self.screen.blit(self.score_image,self.scpre_rect)
